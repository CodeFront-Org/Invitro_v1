            ...
            <div class="col-12">
                <div class="card" style="border-radius:0px 15px 15px 15px;box-shadow: 2px 3px 3px 2px rgba(9, 107, 255, 0.179);">
                    ...
                    <div class="table-responsive" style="overflow-x: auto;">
                        <form action="{{route('/complete-order')}}" method="POST"onsubmit="document.getElementById('newaddbtn').disabled = true;">
                            @method('GET')
                        ...
                        <div class="modal-footer1">
                            <button class="btn p-1" id="newaddbtn" style="background-color: #08228a9f;color: white" type="submit">
                                    Submit
                            </button>
