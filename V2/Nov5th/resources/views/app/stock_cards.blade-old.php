...
@endif
        <div class="row mt-1">
            <div class="col-12">
                ...
                <div class="card" style="border-radius:0px 15px 15px 15px;box-shadow: 2px 3px 3px 2px rgba(9, 107, 255, 0.179);">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <button type="button" style="background-color: #08228a9f;color: white;border-radius: 1rem;" class="btn btn-lg" data-bs-toggle="modal" data-bs-target="#modal_stocks_card">
                                        <i class='fas fa-add' aria-hidden='true'></i> Add +
                                    </button>
                                </div>
                            </div>
                            <br> <br>
                ...
                <div id="modal_stocks_card" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog modal-dialog-sm modal-dialog-centered">
                        <div class="modal-content">
                            <form action="add_stock_card" class="stock_cards_btn" method="post" >
                            @csrf
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">STOCK CARD -  ENTRY</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group row">
                                            ...
                                            @endphp
                                                       ...
                                                       <label for="p_name" class="form-label col-2">Item </label>
                                    ...
                                    <div class="input-group row">
                                        <label for="field-23" class="form-label col-2">Size</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-23" placeholder=" " required>
                                    </div>

                                    <div class="input-group row">
                                        <label for="field-24" class="form-label col-2">At Hand</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-24" placeholder=" " required>
                                    </div>

                                    <div class="input-group row">
                                        <label for="field-24" class="form-label col-2">Out</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-24" placeholder=" " required>
                                    </div>

                                    <div class="input-group row">
                                        <label for="field-24" class="form-label col-2">In</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-24" placeholder=" " required>
                                    </div>

                                    <div class="input-group row">
                                        <label for="field-24" class="form-label col-2">Balance</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-24" placeholder=" " required>
                                    </div>

                                    <div class="input-group row">
                                        <label for="field-24" class="form-label col-2">Remarks</label>
                                        <input type="text" name="batch_no" value="" class="form-control col" id="field-24" placeholder=" " required>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button class="btn rounded-pill p-1" id="stock_cards_btn" style="width: 100%; background-color: #08228a9f;color: white" type="submit">
                                        Submit
                                </button>
                                <button class="btn rounded-pill p-1" id="stock_cards_btn" style="width: 100%; background-color: #08228a9f;color: white;display:none;" type="button">
