...
@endif
        <div class="row mt-1">
            <div class="col-12">
                ...
                <!--Edit Epiry date Modal -->
                @foreach ($stock_array as $item)
                <div id="modal-expiry-{{$item['id']}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog modal-dialog-sm modal-dialog-centered">
                        <div class="modal-content">
                            <form action="save_ExpiryDate" class="changeExpiryDate" method="post" >
                            @csrf
                            ...
                            <div class="modal-footer">
                                <button class="btn rounded-pill p-1" id="changeExpiryDate{{$item['id']}}" style="width: 100%; background-color: #08228a9f;color: white" type="submit">
                                        Submit
                                </button>
                                <button class="btn rounded-pill p-1" id="changeExpiryDate{{$item['id']}}" style="width: 100%; background-color: #08228a9f;color: white;display:none;" type="button">
