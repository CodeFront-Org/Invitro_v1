...
@section('content')
    ...
    <div class="card shadow-md mb-4 mt-3">
        <div class="card-body">
            <form method="GET" action="{{route('cards.index')}}">
                <div class="row g-3">
                    <div class="col-md-3">
                        <label for="search_id3" class="form-label fw-bold">Product</label>
                        <div class="input-group">
                            <input type="text" name='name' id='search_id3' class='product-search form-control'
                                placeholder="Search product..." value=''>
                            <span class="input-group-text"><i class="mdi mdi-magnify"></i></span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="p1_name" class="form-label fw-bold">Destination</label>
                        <input type="text" list="regnoo123" class="form-control" id="p1_name" name='destination_filter'
    ...
    <div class="row mb-3 mt-4">
        <div class="col-12 d-flex justify-content-end gap-2">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-plus-circle me-1"></i> New Stock Card
            </button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name='name' id='search_id10' class='product-search form-control'
                            ...
                            {{-- <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="size" class="form-control" id="field-2l" placeholder="size"
                                        required>
                                </div>
                            </div> --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="at_hand" class="form-control" id="fieldAtHand"
                                        placeholder="at hand" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" id='stock_out'>
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="1" oninput='updateBalanceOut();' name="out"
                                        class="form-control" id="fieldOut" placeholder="out">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" id='stock_in'>
                                <div class="mb-3">
                                    ...
                                    <input type="number" oninput='updateBalanceIN();' name="in" class="form-control"
                                        id="fieldIN" placeholder="in">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="balance" class="form-control balanceinput" id="field-2l"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="textarea" value="My Comments" name="remarks" class="form-control"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{route('cards.update',$item['id'])}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" list="regnoo" parsley-trigger="change" required class="form-control"
                                        id="p_name" name='name' autocomplete="off" value="{{$item['item']}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="field-2l" class="form-label">At-hand</label>
                                    <input type="number" name="at_hand" value="{{$item['at_hand']}}" class="form-control"
                                        id="priceInput11" placeholder="at hand" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="field-2l" class="form-label">Out</label>
                                    <input type="number" name="out" value="{{$item['out']}}" min=0
                                        class="form-control stocksvalue" id="field-2l" placeholder="out" required hidden>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="field-2l" class="form-label">In</label>
                                    <input type="number" name="in" value="{{$item['in']}}" min=0
                                        class="form-control stocksvalue" id="field-2l" placeholder="in" required hidden>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="field-2l" class="form-label">Balance</label>
                                    <input type="number" name="balance" value="{{$item['balance']}}" min=0
                                        class="form-control" id="field-2l" placeholder="balance" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="field-2" class="form-label">Remarks</label>
                                    <textarea id="textarea" value="My Comments" name="remarks" class="form-control"
                                        maxlength="300" rows="3" placeholder="Your Remarks">{{$item['remarks']}}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn rounded-pill p-1" id="editorderbtn{{$item['id']}}"
                            style="width: 100%; background-color: #08228a9f;color: white" type="submit">
                            Submit
                        </button>
                        <button class="btn rounded-pill p-1" id="editorderloader{{$item['id']}}"
                            style="width: 100%; background-color: #08228a9f;color: white;display:none;" type="button">
                            <span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                            Saving Data...
                        </button>
                    </div>
    ...
    <input type="hidden" id="price11{{ preg_replace('/[^a-zA-Z0-9]/', '', $item['name']) }}" value="{{$item['at_hand']}}"
        data-is-at-hand="{{ $item['is_at_hand'] }}">
    @endforeach --}}
