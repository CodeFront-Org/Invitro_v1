...
@section('content')
    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end gap-2">
            ...
            @endrole
            <a href="{{route('/product-orders', ['product_id' => $product_id])}}" class="btn btn-info">
                <i class="mdi mdi-eye me-1"></i> View Orders
            </a>
        </div>
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="o_level" class="form-control" id="field-2l"
                                        placeholder="order level" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
    ...
    @foreach ($data as $item1)
        <div id="con-close-modal-view-audit-{{$item1['id']}}" class="modal fade" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <form class="orderlevelForm" method="post">
                        ...
                        <div class="modal-body">
                            <button id="excelbtn" type="button" class="btn btn-success"><i
                                    class="fa fa-file-excel bg-success"></i> excel </button>
                            <div class="table-responsive">
                                <table style="font-family: 'Times New Roman', Times, serif"
                                    class="table table-bordered nowrap text-center" id="salestable"
    ...
    <!--Edit Audit Modal -->
    @foreach ($data as $item)
        <div id="con-close-modal-edit-audit-{{$item['id']}}" class="modal fade" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-sm modal-dialog-centered">
                <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="textarea" value="My Comments" name="comments" class="form-control"
