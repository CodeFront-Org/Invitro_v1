    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-plus-circle me-1"></i> Add Staff
            </button>
        </div>
    </div>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#con-close-modal-edit-{{$item['id']}}" title="Edit Staff">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="f_name" class="form-control" id="field-2n"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="l_name" class="form-control" id="field-2l"
                ...
                <div class="modal-content">
                    <form class="editForm" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$item['last_name']}}" name="l_name" class="form-control"
                                            id="field-2le" placeholder="last name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary w-100" id="editloader{{$item['id']}}" style="display:none;" type="button">
                                <span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                                Saving Data...
                            </button>
                        </div>
