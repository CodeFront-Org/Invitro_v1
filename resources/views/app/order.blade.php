...
@section('content')
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="{{route('/product-orders', ['product_id' => $item['product_id']])}}"
                                            class="btn btn-info" title="View Related Orders">
    ...
    <div id="con-close-modal-add-1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="newOrderForm12" method="post" action="{{route('/place-order')}}"
                    onsubmit="document.getElementById('newaddbtn').disabled = true;">
                    @csrf
                    @method('get')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="destination" class="form-control" id="field-2l"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="receipt" class="form-control" id="field-2l"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="cash" class="form-control" id="field-2l"
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-primary w-100" id="newaddbtn" type="submit">
                            <i class="mdi mdi-check-circle me-1"></i> Submit
                        </button>
                        <button class="btn btn-secondary w-100" id="newaddloader" style="display:none;" type="button">
    ...
    <!-- Return Stock Modal -->
    @foreach ($orders as $item)
        <div id="con-close-modal-return-{{$item['id']}}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" action="{{route('/return-stock')}}">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Return Stock: Name-> {{$item['product_name']}} Batch-> {{$item['batch']}}
                            </h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="field-2" class="form-label">Remarks</label>
                                        <textarea id="textarea" class="form-control" required maxlength="300" rows="3"
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary w-100" id="editloader" style="display:none;" type="button">
                                <span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                                Saving Data...
                            </button>
                        </div>
    ...
    <div id="con-close-modal-edit-1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="settiingsForm" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="field-2n"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="field-2n" class="form-label">Amount</label>
                                    <input type="number" name="amount" class="form-control" id="field-2n"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="field-2l" class="form-label">Date</label>
                                    <input type="date" name="date" class="form-control" id="field-2l"
