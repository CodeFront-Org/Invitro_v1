...
@section('content')
    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-plus-circle me-1"></i> Approve New Product
            </button>
        </div>
    </div>
        ...
        <form action="{{route('approve.store')}}" method="post">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#con-close-modal-edit-{{$item['id']}}" title="Edit Product">
            ...
            <div class="card-footer d-flex justify-content-end bg-transparent border-top-0">
                <button type="submit" class="btn btn-success">
                    <i class="mdi mdi-check-all me-1"></i> Approve Selected
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-plus-circle me-1"></i> Approve New Stock
            </button>
        </div>
    </div>
    <div class="card shadow-md">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-left"
                                        style="min-width: 100px; max-width: 100px; overflow: hidden; font-size: 12px;">
                                        {{$item['remarks']}}
                                    </td>
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button type="button" onclick="del(this)" value="{{$item['id']}}"
                                                class="btn btn-danger" title="Delete Stock">
                                                <i class="mdi mdi-delete"></i>
                                            </button>
                                        </div>
                                    </td>
    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end">
            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-plus-circle me-1"></i> Approve Orders
            </button>
        </div>
    </div>
            <div class="card shadow-md">
                                ...
                                <tbody>
                                    @foreach ($orders as $item)
                                        <tr>
                                            ...
                                            <td>{{$item['date']}}</td>
                                            <td class="text-left"
                                                style="min-width: 130px; max-width: 130px; overflow: hidden; font-size: 12px;">
                                                {{$item['rmks']}}
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <button type="button" onclick="del_order(this)" value="{{$item['order_id']}}" 
    ...
    <div class="row mt-3 mb-3">
        <div class="col-12 d-flex justify-content-end">
            <button type="button" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target="#con-close-modal-add-1">
                <i class="mdi mdi-alert-circle me-1"></i> Approve Order-Level Limit
            </button>
        </div>
    </div>
            <div class="card shadow-md">
                                ...
                                <tbody>
                                    @foreach ($approve_orders as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="del_order_limit(this)" value="{{$item['id']}}" 
                                                    class="btn btn-danger btn-sm" title="Delete Limit Request">
                                                    <i class="mdi mdi-delete"></i>
                                                </button>
                                            </td>
                                            <td style="color:green">
                                                <input type="checkbox" autocomplete="off" class="custom-control-input"
                                                    name="status[]" value="{{$item->id}}">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="modal-content">
                    <form class="orderlevelForm" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="e_period" value="{{$item['expire_days']}}"
                                            class="form-control" id="field-2l" placeholder="Expiry period in days" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary w-100" id="editorderloader{{$item['id']}}" style="display:none;" type="button">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$item['invoice']}}" name="invoice" class="form-control"
                                            id="field-2n" placeholder="source">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="field-2n" class="form-label">Delivery Note</label>
                                        <input type="text" value="{{$item['d_note']}}" name="d_note" class="form-control"
                                            id="field-2n" placeholder="source">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" value="{{$item['expiry_date']}}" name="e_date" class="form-control"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="textarea" name="remarks" class="form-control" maxlength="300" rows="3"
                                            placeholder="Your Remarks">{{$item['remarks']}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        //Deleting Order_Level_Limit
        function del_order_limit(e) {
            let id = e.value;
            var type = 1;//For knowing deletion operation is coming from settings
            var type_p = 12;
