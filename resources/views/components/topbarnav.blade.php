...
<div class="navbar-custom">
                ...
                <div class="app-search-box">
                    <div class="input-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name='name' id='search_id_topsearch' class='product-search form-control'
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="d-flex align-items-start">
                                    <img class="d-flex me-2 rounded-circle"
                                        src="{{asset('images/users/profile/default.jpg')}} alt=" user image"
                                        height="32">
                                    <div class="w-100">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-lg">
                ...
                <div class="noti-scroll" data-simplebar>
                    ...
                    <a href="{{route('approve.index')}}" class="dropdown-item notify-item active">
                        ...
                        <p class="text-muted mb-0 user-msg">
                            <small>Hi, you have <b>{{$approval1}}</b> new {{$approval1>1?"Stocks":"Stock"}} to
                                approve.</small>
                        </p>
                    </a>
                    @endif
                    ...
                    <a href="{{route('approve.index')}}" class="dropdown-item notify-item active">
                        ...
                        <p class="text-muted mb-0 user-msg">
                            <small>Hi, you have <b>{{$approval2}}</b> new {{$approval2>1?"Orders":"Order"}} to
                                approve.</small>
                        </p>
                    </a>
                    @endif
                    ...
                    <a href="{{route('approve.index')}}" class="dropdown-item notify-item active">
                        ...
                        <p class="text-muted mb-0 user-msg">
                            <small>Hi, you have <b>{{$approval3}}</b> new {{$approval3>1?"Products":"Product"}} to
                                approve.</small>
                        </p>
                    </a>
                    @endif
        ...
        <li class="dropdown notification-list topbar-dropdown">
            @auth
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                    ...
                    @else
                        <img src="{{asset('images/users/profile/' . Auth::user()->path)}}" alt="user-image"
            ...
            @else
                <a class="nav-link" href="{{ route('login') }}">
                    <span class="pro-user-name ms-1">Login</span>
                </a>
            @endauth
    ...
    <div class="logo-box">
        <a href="{{route('stock.index')}}" class="logo logo-light text-center">
            <span class="logo-sm">
        ...
        <a href="{{route('stock.index')}}" class="logo logo-dark text-center">
            <span class="logo-sm">
                <img src="{{asset('images/Logo/logo.png')}}" alt="" width="60">
            </span>
            <span class="logo-lg" style="left:50px;">
